...
pub const DUPLICATE_MESSAGE_ID: &str = "ID de message en double";
pub const SENDER_NOT_IN_NODES: &str = "Expéditeur du message non présent dans la liste des nœuds";
pub const SIGNAL_EXTENDS_BEYOND_MESSAGE: &str = "Le signal dépasse la limite du message";
pub const INVALID_RANGE: &str = "Plage invalide : min > max";
