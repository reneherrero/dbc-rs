...
// Note: MAX_MESSAGES and MAX_SIGNALS_PER_MESSAGE are now defined in limits.rs
// (generated by build.rs) and can be overridden at build time.
// Access them via Signals::max_capacity() and MessageList::max_capacity().
